...
simple-s3 bucket list

# Create a new bucket

simple-s3 bucket create --name my-test-bucket --region us-east-2

# Upload a file

simple-s3 bucket upload --file ./local.txt --key myfile.txt --name my-test-bucket --region us-east-2

# List objects in the bucket

simple-s3 bucket list-objects --name my-test-bucket --region us-east-2

# Download the file

simple-s3 bucket download --key myfile.txt --output ./downloaded.txt --name my-test-bucket --region us-east-2

# Delete the object

simple-s3 bucket delete-object --key myfile.txt --name my-test-bucket --region us-east-2

# Delete the bucket

simple-s3 bucket delete --name my-test-bucket --region us-east-2
